...
stage2_weight_folder = (
    './weights/UnetPlusPlus/stage2_dibco_'
    + base_model_name + '_'
...
stage3_patch_weight_folder = (
    './weights/UnetPlusPlus/stage3_dibco_'
    + base_model_name + '_'
    + str(int(lambda_bce)) + '_'
    + str(generator_lr) + '/'
)
...
weight_list = [
    ...
    for w in weight_list if 'UnetPlusPlus_patch' in w
]
weight_list = sorted(weight_list)
print('Stage3 patch weight:', weight_list)

model_stage3_patch = smp.UnetPlusPlus(base_model_name, encoder_weights=encoder_weights, in_channels=3)
...
stage3_resize_weight_folder = (
    './weights/UnetPlusPlus/stage3_resize_dibco_'
    + base_model_name + '_'
    + str(int(lambda_bce)) + '_'
    + str(generator_lr) + '/'
)
...
weight_list = [
    ...
    for w in weight_list if 'UnetPlusPlus_global' in w
]
weight_list = sorted(weight_list)
print('Stage3 resize (global) weight:', weight_list)

model_stage3_global = smp.UnetPlusPlus(base_model_name, encoder_weights=encoder_weights, in_channels=3)
